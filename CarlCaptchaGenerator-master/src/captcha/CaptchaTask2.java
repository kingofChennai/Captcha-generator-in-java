...
public class CaptchaTask2 implements Runnable{
	
	private String captchatext;
	private String filename;
	public CaptchaTask2(String captchatext, String filename) {
		super();
	...
	public void run() {
		...
		File outputfile = new File("cap2/"+filename+".jpg");
	...
	private BufferedImage getCaptchaImage() {
        try {
            ...
            BufferedImage bufferedImage = ImageIO.read( new File("cap2.jpg"));//new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
