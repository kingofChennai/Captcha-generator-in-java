...
public class ImageUtilS
{
   ...
   public static void saveAnimatedGIF(OutputStream out, List<GifFrames> frames, int loopCount) throws Exception
   {
      ...
      int p = 0;
      for (GifFrames frame : frames)
      {
         ImageWriteParam iwp = iw.getDefaultWriteParam();
         IIOMetadata metadata = iw.getDefaultImageMetadata(new ImageTypeSpecifier(frame.img), iwp);
         ImageUtilS.configureGIFFrame(metadata, String.valueOf(frame.delay / 10L), p++, frame.disposalMethod, loopCount);
